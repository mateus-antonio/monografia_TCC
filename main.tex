...
\titulo{CONSTRUÇÃO E CONTROLE DE UM POSICIONADOR LINEAR UTILIZANDO REALIMENTAÇÃO DE ESTADOS} %TCC
...
%
\include{elementos/folha_aprovacao}
% ---
...
\input{elementos/resumo.tex}
\input{elementos/abstract.tex}
