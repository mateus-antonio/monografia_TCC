...
Com o sistema de controle agora elaborado, este foi colocado a teste tanto em um ambiente de simulação quanto na bancada, neste capítulo são apresentados os resultados obtidos.
...
Pode-se afirmar que, na prática, a resposta observada se assemelha a de um sistema de primeira ordem, tendo em vista que não ha \textit{overshoot}, a saída não ultrapassa o valor da referência. Mesmo assim, considera-se que o sistema de controle atingiu o principal objetivo proposto: Guiar o carro para a referência de posição.
