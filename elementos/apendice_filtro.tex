...
\label{apend:1}
Para o projeto do filtro, foi considerada uma frequência de corte de 15 Hz e um período de amostragem de 0,01 segundos. Em particular, projetou-se um filtro digital do tipo Butterwoth de segunda ordem \cite{butterworth1930theory}. Especificamente, o seguinte filtro foi utilizado:
...
\begin{equation}
    y_f[k]= 0,7478y_f[k-1] -0,2722y_f[k-2] +0,1311y[k] +0,2622y[k-1]+0.1311y[k-2]
    \label{filtro}
\end{equation}
